...
int rec(int level,int time_taken,int item_taken){
    ...
    //max skill i can make from [level...n-1] ,if [0..level-1] is decided and time_taken and item_taken are parameters
...
void solve(){
    ...
    memset(dp,-1,sizeof(dp));//memset works for value of -1 and 0
    rec(0,0,0);
    cout<<dp[0]<<"\n";
